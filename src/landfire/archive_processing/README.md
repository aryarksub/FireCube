...
The workflow automates the process of categorizing fire events by their optimal LANDFIRE version and slicing the full-extent datasets into PyroStack fuel layers.

## Script Reference

* `build_fire_list.py`  
    Retrieves all fires from the PyroStack fire list that correspond with a specified LANDFIRE version, collecting their metadata used for extraction.
* `extract_tifs.py`  
